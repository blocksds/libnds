...
#ifndef NDS_CAMERA_H__
#define NDS_CAMERA_H__
...
#define IC2REG_APT_R_GAMMA_CURVE_KNEES(n)	(0x3604+((n)*2)) // big endian, contains two byte values
#define IC2REG_APT_G_GAMMA_CURVE_KNEES(n)	(0x3618+((n)*2)) // big endian, contains two byte values
#define IC2REG_APT_B_GAMMA_CURVE_KNEES(n)	(0x362C+((n)*2)) // big endian, contains two byte values
...
#define MCUREG_APT_MODE_A_SPECIAL_EFFECT		(MCUREG_APT_16BIT | 0x2759)
#define MCUREG_APT_MODE_B_SPECIAL_EFFECT		(MCUREG_APT_16BIT | 0x275B)
