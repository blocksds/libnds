...
#define EXMEMCNT_SRAM_TIME_MASK             (3 << EXMEMCNT_SRAM_TIME_SHIFT)
...
#define EXMEMCNT_ROM_TIME1_MASK             (3 << EXMEMCNT_SRAM_TIME_SHIFT)
...
#define EXMEMCNT_ROM_TIME2_MASK             (1 << EXMEMCNT_ROM_TIME2_SHIFT)
...
#define EXMEMCNT_PHI_CLOCK_MASK             (3 << EXMEMCNT_PHI_CLOCK_SHIFT)
